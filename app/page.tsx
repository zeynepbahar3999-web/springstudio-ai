...
const CAT_MAP: Record<string, string> = {
  ...
  'text-to-3d':'Text to 3D','3d-to-3d':'3D to 3D',
  'text-to-audio':'Text to Audio','text-to-speech':'Text to Speech',
  'audio-to-audio':'Audio to Audio','audio-to-video':'Audio to Video',
  'audio-to-text':'Audio to Text','speech-to-text':'Speech to Text',
  'vision':'Vision & LLM','llm':'Vision & LLM','image-to-text':'Vision & LLM',
  'json':'Vision & LLM','text-to-json':'Vision & LLM','training':'Training',
  'audio':'Audio Processing','speech-to-speech':'Audio Processing',
  'video':'Video to Video','video-to-text':'Vision & LLM',
}
